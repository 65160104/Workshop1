                ...
                <div class="container-fluid">
                    {{-- <div class="row mb-2"> --}}
                        {{-- <div class="col-sm-6"> --}}
                            <center>
                            <br>
                             <h1 class="m-0">Worshop#HTML-FORM</h1>
                             <br>
                             <form action="#">
                                ...
                                <table>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input id="radio_d"
                                                       type="radio"
                                                       name="same_radioA"/>
                                                <label for="radio_d">ชาย</label>
                                                <input id="radio_e"
                                                        type="radio"
                                                        name="same_radioA" />
                                                <label for="radio_e">หญิง</label>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                        ...
                                        <tr>
                                            ...
                                            <td style="width: 5px;">
                                                <input  style="float: right; width: 150px ;"  type="submit" value="Submit"style=";">
                                            </td>
                                        </tr>
                                    </table>
                                </form>
